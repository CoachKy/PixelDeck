    ...
    bool Strict)
{
    public static CompatibilityOptions Parse(string[] args)
    {
        ...
        var gamesFolder = Path.Combine(repositoryRoot, "Games", "Nintendo");
        ...
        for (var index = 0; index < args.Length; index++)
        {
            switch (args[index])
            {
                ...
                case "--output":
                    ...
                    break;
                case "--frames":
                    frames = ParseNumber(ReadValue(args, ref index, "--frames"), "--frames", 120, 216_000);
                    break;
                case "--parallel":
    ...
    public static string HelpText =>
        ...
        PixelNES compatibility laboratory
          ...
          --games <folder>    NES image folder (default: Games/Nintendo)
          --output <folder>   Report folder (default: artifacts/nes-compatibility/run-*)
          --frames <count>    Frames per supported image, 120-216000 (default: 600)

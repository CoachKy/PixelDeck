...
`1.7.011` is the final 1.7 patch build; it preserves the certified core
envelope and pairs it with PixelDeck's default, reversible horizontal-overscan
mask. The current feature generation is documented in
[PixelNES 1.8 certification](PIXELNES-1.8-CERTIFICATION.md).
